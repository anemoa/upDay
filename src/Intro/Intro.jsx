    ...
    return (
        <div className='snap-y snap-mandatory h-screen w-screen overflow-y-auto'>
            ...
            <div className='h-screen snap-start flex-grow flex-col items-center justify-center'>
                <div className='flex flex-col md:flex-row w-[80%] max-w-[1344px] mx-auto justify-between items-center relative pt-[80px]'>
                    <div className='fade-in flex flex-col items-start w-full md:w-auto'>
                        <h1 className='text-5xl font-bold text-gray-800 leading-snug mb-4 animate-slide-up'>
                            좋은 습관, <br />
                            매일 실천하고 
                            <br className='md:hidden'/>싶으신가요?
                        </h1>
                        ...
                        {/* 이미지를 여기로 이동하고 모바일에서만 표시 */}
                        <div className='w-full flex justify-end md:hidden mb-8'>
                            <img
                                src={Charac}
                                alt='Character'
                        ...
                        {/* 반응형 버튼 크기 조정 */}
                        <button className='btn btn-key w-full md:w-80 h-14'
                                onClick={handleClick}>
                            성장하기
                        </button>
                    </div>
                    ...
                    {/* 데스크톱에서만 이미지 표시 */}
                    <div className='w-40% justify-center hidden md:flex'>
                        <img
                            src={Charac}
                            alt='Character'
                ...
                <div className='animate-bounce flex items-center justify-center mt-20 hidden md:flex'>
            ...
            <div className='h-screen snap-start flex-grow flex-col items-center justify-center'>
                <div className="fade-in w-[80%] max-w-[1344px] mx-auto relative z-10 text-center pt-[180px]">
                    ...
                    <div className='w-full flex justify-center md:hidden'>
                        <img src={BgMobile} alt="Background" className='absolute top-0 w-auto h-[900px]' />
                    ...
                    {/* 작동 되는 코드 웹, 모바일 둘다 잘됨 */}
                        <div className='h-screen snap-start flex-grow flex-col'>
                            <div className='flex flex-col space-y-8 w-[70%] max-w-[1344px] mx-auto pt-10'>
                                <FadeInSection delay={200}>
                                ...
                                <SpeechBubble text="📈 함께라서 더 빠르고, 더 멀리 나아가는 여정!" position="left" />
                                </FadeInSection>
                                <FadeInSection delay={800}>
                                <SpeechBubble text="🔥 혼자가 아닌 함께, 더 즐겁고 쉽게 목표 완수!" position="right" />
                                </FadeInSection>

                                <FadeInSection delay={800}>
                                <p className='text-2xl text-center pt-35 leading-[2] font-bold pt-10'>
                                    좋은 습관으로 매일 <br className='md:hidden'/>더 나은 나를 만들어보세요! <br />
                                    오늘부터 <span className='text-3xl text-blue-500 font-bold'>
                                            UpDay
